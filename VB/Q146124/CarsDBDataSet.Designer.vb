...
Namespace Q146124
	...
	Partial Public Class CarsDBDataSet
		...
		Partial Public Class CarSchedulingDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddCarSchedulingRow(ByVal CarId As Integer, ByVal UserId As Integer, ByVal AllDay As Boolean) As CarSchedulingRow
				Dim rowCarSchedulingRow As CarSchedulingRow = (CType(Me.NewRow(), CarSchedulingRow))
				Dim columnValuesArray() As Object = { Nothing, CarId, UserId, AllDay}
...
Namespace Q146124.CarsDBDataSetTableAdapters
	...
	Partial Public Class CarSchedulingTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `CarScheduling` WHERE ((`ID` = ?) AND ((? = 1 AND `CarId` IS NULL) OR" & " (`CarId` = ?)) AND ((? = 1 AND `UserId` IS NULL) OR (`UserId` = ?)) AND ((? = 1" & " AND `AllDay` IS NULL) OR (`AllDay` = ?)))"
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `CarScheduling` (`CarId`, `UserId`, `AllDay`) VALUES (?, ?, ?)"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `CarScheduling` SET `CarId` = ?, `UserId` = ?, `AllDay` = ? WHERE ((`ID` =" & " ?) AND ((? = 1 AND `CarId` IS NULL) OR (`CarId` = ?)) AND ((? = 1 AND `UserId` " & "IS NULL) OR (`UserId` = ?)) AND ((? = 1 AND `AllDay` IS NULL) OR (`AllDay` = ?))" & ")"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ID, CarId, UserId, AllDay FROM CarScheduling"
		...
		Public Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_CarId As Global.System.Nullable(Of Integer), ByVal Original_UserId As Global.System.Nullable(Of Integer), ByVal Original_AllDay As Boolean) As Integer
			...
			Me.Adapter.DeleteCommand.Parameters(6).Value = (CBool(Original_AllDay))
		...
		Public Overridable Function Insert(ByVal CarId As Global.System.Nullable(Of Integer), ByVal UserId As Global.System.Nullable(Of Integer), ByVal AllDay As Boolean) As Integer
			...
			End If
			Me.Adapter.InsertCommand.Parameters(2).Value = (CBool(AllDay))
		...
		Public Overridable Function Update(ByVal CarId As Global.System.Nullable(Of Integer), ByVal UserId As Global.System.Nullable(Of Integer), ByVal AllDay As Boolean, ByVal Original_ID As Integer, ByVal Original_CarId As Global.System.Nullable(Of Integer), ByVal Original_UserId As Global.System.Nullable(Of Integer), ByVal Original_AllDay As Boolean) As Integer
			If (CarId.HasValue = True) Then
			...
			End If
			Me.Adapter.UpdateCommand.Parameters(2).Value = (CBool(AllDay))
			Me.Adapter.UpdateCommand.Parameters(3).Value = (CInt(Fix(Original_ID)))
			If (Original_CarId.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(4).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(5).Value = (CInt(Fix(Original_CarId.Value)))
			Else
			...
			If (Original_UserId.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(7).Value = (CInt(Fix(Original_UserId.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(6).Value = (CObj(1))
				Me.Adapter.UpdateCommand.Parameters(7).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.UpdateCommand.Parameters(8).Value = (CObj(0))
			Me.Adapter.UpdateCommand.Parameters(9).Value = (CBool(Original_AllDay))
